...
class LadyBossBot {
  ...
  _startChannelMessageListner() {
    this.bot.on('start', (function() {
      var message = 'Hello I am lady-boss-bot';
      var fallBack = 'lady-boss-bot is here';
      var color = 'warning';
      var title = 'lady-boss-bot greetings';
      var titleLink = 'Hello I am lady-boss-bot';
      ...
      attachments: [
        {
          ...
          'title': title ? title : 'lady-boss-bot',
